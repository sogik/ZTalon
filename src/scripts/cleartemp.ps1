...
Remove-Item -Path "$env:SystemDrive\Windows\Prefetch" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
New-Item -Path "$env:SystemDrive\Windows\Prefetch" -Name "Prefetch" -ItemType Directory -ErrorAction SilentlyContinue | Out-Null